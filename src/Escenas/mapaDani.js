...
export class MapaDani extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.collider(this.arañas,this.torreta,(araña,torreta)=>{
            torreta.vidas=torreta.vidas-1
            console.log('torreta.vidas')
            this.mordiscoAraña=true
            setTimeout(()=>{
                this.mordiscoAraña=false
            },1000)
    ...
    update() {
        if (Phaser.Input.Keyboard.JustDown(this.keyQ)){
            if(this.torreta==null){
                //this.torreta=this.add.image(this.player2.x,this.player2.y,'torreta').setScale(0.5)
                this.torreta = this.physics.add.sprite(this.player2.x,this.player2.y,'torreta',0).setScale(0.5)
                this.torreta.vidas=5
            }
        }
